<template>
  <section class="cta" ref="sectionRef">
    ...
    <div class="cta__container" :class="{ 'cta__container--visible': isVisible }">
      ...
      <h2 class="cta__title">
        {{ t('ctaSection.title') }}
        <span class="cta__title-highlight">{{ t('ctaSection.titleHighlight') }}</span>
      </h2>
      ...
      <div class="cta__actions">
        ...
        >
          ...
          <span>{{ t('ctaSection.registerNow') }}</span>
